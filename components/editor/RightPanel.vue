    ...
    <div class="panel-content">
      ...
      <PanelSection title="Transform" icon="transform">
        <div class="space-y-3">
          ...
          <UiSlider
            label="X"
            :model-value="sceneStore.position.x"
            :min="-5" :max="5" :step="0.01" :decimals="2"
            @update:model-value="sceneStore.setPosition('x', $event)"
          />
          <UiSlider
            label="Y"
            :model-value="sceneStore.position.y"
            :min="-5" :max="5" :step="0.01" :decimals="2"
            @update:model-value="sceneStore.setPosition('y', $event)"
          />
          <UiSlider
            label="Z"
            :model-value="sceneStore.position.z"
            :min="-5" :max="5" :step="0.01" :decimals="2"
            @update:model-value="sceneStore.setPosition('z', $event)"
          />
          ...
          <UiSlider
            label="X"
            :model-value="sceneStore.rotation.x"
            :min="-3.14159" :max="3.14159" :step="0.01" :decimals="1"
            :unit="'°'"
            @update:model-value="sceneStore.setRotation('x', $event)"
          />
          <UiSlider
            label="Y"
            :model-value="sceneStore.rotation.y"
            :min="-3.14159" :max="3.14159" :step="0.01" :decimals="1"
            :unit="'°'"
            @update:model-value="sceneStore.setRotation('y', $event)"
          />
          <UiSlider
            label="Z"
            :model-value="sceneStore.rotation.z"
            :min="-3.14159" :max="3.14159" :step="0.01" :decimals="1"
            :unit="'°'"
            @update:model-value="sceneStore.setRotation('z', $event)"
          />
          ...
          <UiSlider
            label="Scale"
            :model-value="sceneStore.scale"
            :min="0.1" :max="3" :step="0.01" :decimals="2"
            @update:model-value="sceneStore.setScale($event)"
          />
        </div>
      </PanelSection>
      ...
      <PanelSection title="Material" icon="material">
        <div class="space-y-3">
          <UiSlider
            label="Metalness"
            :model-value="sceneStore.metalness"
            :min="0" :max="1" :step="0.01" :decimals="2"
            @update:model-value="sceneStore.setMetalness($event)"
          />
          <UiSlider
            label="Roughness"
            :model-value="sceneStore.roughness"
            :min="0" :max="1" :step="0.01" :decimals="2"
            @update:model-value="sceneStore.setRoughness($event)"
          />
          <UiSlider
            label="Opacity"
            :model-value="sceneStore.opacity"
            :min="0" :max="1" :step="0.01" :decimals="2"
            @update:model-value="sceneStore.setOpacity($event)"
          />
      ...
      <PanelSection title="Lighting" icon="lighting">
        <div class="space-y-3">
          <UiSlider
            label="Ambient"
            :model-value="sceneStore.ambientIntensity"
            :min="0" :max="2" :step="0.01" :decimals="2"
            @update:model-value="sceneStore.setAmbientIntensity($event)"
          />
          <UiSlider
            label="Directional"
            :model-value="sceneStore.directionalIntensity"
            :min="0" :max="3" :step="0.01" :decimals="2"
            @update:model-value="sceneStore.setDirectionalIntensity($event)"
          />
          ...
          <UiSlider
            label="X"
            :model-value="sceneStore.lightPosition.x"
            :min="-10" :max="10" :step="0.1" :decimals="1"
            @update:model-value="sceneStore.setLightPosition('x', $event)"
          />
          <UiSlider
            label="Y"
            :model-value="sceneStore.lightPosition.y"
            :min="-10" :max="10" :step="0.1" :decimals="1"
            @update:model-value="sceneStore.setLightPosition('y', $event)"
          />
          <UiSlider
            label="Z"
            :model-value="sceneStore.lightPosition.z"
            :min="-10" :max="10" :step="0.1" :decimals="1"
            @update:model-value="sceneStore.setLightPosition('z', $event)"
          />
        </div>
      </PanelSection>
      ...
      <PanelSection title="Camera" icon="camera">
        <div class="space-y-3">
          <UiSlider
            label="Field of View"
            :model-value="sceneStore.fov"
            :min="30" :max="120" :step="1" :decimals="0"
            :unit="'°'"
            @update:model-value="sceneStore.setFov($event)"
          />
      ...
      h('button', {
        ...
        h('div', { class: 'flex items-center gap-2' }, [
          h('svg', {
            ...
            class: 'text-accent opacity-70'
          }, [
            h('path', {
              d: iconPaths[props.icon] || 'M4 4h8v8H4z',
        ...
        h('svg', {
          ...
          h('path', {
            d: 'M2 4L6 8L10 4',
            stroke: '#6B6B8A', 'stroke-width': '1.5',
            'stroke-linecap': 'round', 'stroke-linejoin': 'round'
          })
        ])
      ]),
